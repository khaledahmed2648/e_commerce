import 'package:ecommerce1/controller/bill_one_itemcontroller.dart';
...
class BillOneItemDetails extends StatelessWidget {
  BillOneItemDetails({Key? key}) : super(key: key);
  var billKey = GlobalKey<FormState>();

  @override
  Widget build(BuildContext context) {
    Get.put(BillOneItemControllerImp());

    return Scaffold(
      body: GetBuilder<BillOneItemControllerImp>(builder: (controller) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        leading: Text(
                          '${controller.item!.items_name}',
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(color: Colors.red),
                        ),
                        title: Text(
                          'Quantity : ${controller.item!.items_count}',
                          style: const TextStyle(color: Colors.red),
                        ),
                        trailing: Text(
                          'EGP${controller.itemsSalary}',
                        ),
                      ),
                    ),
                    const SizedBox(
